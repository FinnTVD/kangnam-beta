...
export default function InputCheckBoxAdd({ e, lang, lh, index }) {
    ...
    return (
        <div className='w-fit flex items-center gap-x-[0.75vw] max-md:gap-x-[3.2vw]'>
            ...
            <span
                className='title14-400-150 text-den cursor-pointer max-md:title-mb14-400-150 w-[5.5625vw] max-md:w-[23.74vw] max-md:whitespace-normal max-lg:title-tl14 max-lg:w-[20vw] whitespace-nowrap'
                htmlFor={e?.id}
                onClick={handleToggle}
            >
