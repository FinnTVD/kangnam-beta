    ...
    return (
        <Link href={`/danh-sach-tin-tuc/${newsOtherItem?.translations[0]?.slug}`}>
            <div className='group cursor-pointer w-full h-full bg-white rounded-2xl backdrop-blur-2xl p-[1.5vw] max-md:rounded-[13px] max-md:p-[5.3vw] max-md:py-mb10 shadow-input max-md:shadow-newsDetailMb'>
                ...
                <span className='bg-nau-nhat inline-block title12-400-150 mt-[1vw] py-[0.3125vw] px-[1.125vw] bg-opacity-20 rounded-[100px] text-nau-nhat max-md:pr-[2.6vw] max-md:title-mb10-400-150 max-md:mt-[3.4vw] max-md:py-[1.1vw] max-md:px-[3.7vw] max-md:rounded-[3.3px]'>
                    {newsOtherItem?.postType?.name}
                </span>
                <div className='w-full mt-[0.2625vw]] flex flex-col max-md:mt-[0.8vw]'>
                    <h2 className='mt-[0.25vw] text-den-2 title20-700-150 group-hover:text-[#D6A279] transition duration-300 max-md:title-mb16-700-135'>
                        {newsOtherItem?.translations[0].title}
                    </h2>
                    <span className='text-den-2 title14-400-160 mt-[0.5vw] line-clamp-2 max-md:mt-[0.8vw] max-md:title-mb12-400-150'>
