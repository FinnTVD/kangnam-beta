                                    ...
                                    <div className='pt-[1.13vw] max-md:pt-[6.4vw]'>
                                        ...
                                        >
                                            <svg
                                                ...
                                                viewBox='0 0 15 14'
                                                fill='none'
                                                className='w-[0.875vw] h-[0.875vw] max-md:w-[5vw] max-md:h-[5vw] max-lg:w-[2vw] max-lg:h-[2vw] flex-shrink-0'
                                            >
                                                <path
                                        ...
                                        <div className='flex items-center my-[0.5vw] max-md:my-[2.69vw]'>
                                            <svg
                                                ...
                                                viewBox='0 0 14 14'
                                                fill='none'
                                                className='w-[0.875vw] h-[0.875vw] max-md:w-[5vw] max-md:h-[5vw] max-lg:w-[2vw] max-lg:h-[2vw]'
                                            >
