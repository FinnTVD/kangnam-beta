...
export default function ListProject() {
    ...
    return (
        <section
            id='list-project'
            className='mt-[22vw] relative z-10'
        >
            <div className='flex'>
                <div className={`${show ? 'pr-[1.25vw]' : 'pr-[7.5vw]'} flex-1 pl-[7.5vw]`}>
                    <div
                        className={`${
                            show ? 'w-[63.75vw]' : 'w-screen pr-[7.5vw]'
                        } fixed top-[5.75vw] left-0 z-[9999] bg-white`}
                    >
                        <div className='mt-[2vw] flex items-center justify-between border-b border-solid border-line pl-[7.5vw] pr-[1.25vw]'>
                        ...
                        <article className='pl-[7.5vw] pr-[1.25vw]'>
                            <div className='flex justify-between mt-[1.5vw] mb-[1vw]'>
                                <div className='flex gap-x-[0.31vw]'>
                                    <span className='inline-block opacity-50 text-den title16-400-150'>Hiển thị</span>
                                    <span className='inline-block text-den title16-600-150'>
                    ...
                    <div
                        ...
                        } grid-rows-4 gap-x-[1.25vw] gap-y-[1.87vw]`}
                    >
                        {listProject &&
