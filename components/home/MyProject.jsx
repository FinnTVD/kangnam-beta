        ...
        <section className='pl-[7.5vw] text-den pt-[9.13vw] pb-[10.06vw]'>
            ...
            <div className='flex justify-between items-center pr-[7.5vw] mb-[2vw] mt-[1.5vw]'>
                <ul className='flex gap-x-[1.5vw]'>
                    {arrFilter &&
                        arrFilter.map((e, index) => (
                            <li
                                key={index}
                                className='rounded-[6.25vw] py-[0.59vw] px-[1.5vw] h-fit w-fit border border-solid border-logo shadow-filter title14-400-150'
                            >
                                {e}
                            </li>
                        ))}
                ...
                <div className='flex gap-x-[1.5vw] items-center'>
                    ...
                    >
                        <path
                            d='M0 13C0 8.02944 4.02944 4 9 4H35V22H9C4.02944 22 0 17.9706 0 13Z'
                            fill='#D6A279'
                        />
                        <circle
                            cx='35.5'
            ...
            <div className='flex gap-x-[1.88vw]'>
                <div className='flex-1 grid grid-cols-3 grid-rows-2 gap-x-[1.25vw] gap-y-[1.87vw] h-fit'>
                    {arrItem &&
                        arrItem.map((e, index) => (
                            <div
                                className='w-full'
                ...
                <div className='rounded-tl-[0.5vw]w-[35.5625vw] h-[46.9375vw] rounded-bl-[0.5vw] overflow-hidden relative'>
                    <Map />
                </div>
            </div>
        </section>
