export default function InputCustom({
    ...
    return (
        <div className={`${boxClass} relative`}>
            <input
                type={type}
                className={`${validate ? 'border-red-400' : 'border-[#C5C5C5]'} ${inputClass} ${
            ...
            <label
                ...
                } ${labelClass} absolute left-[1vw] bg-white px-[0.5vw] cursor-pointer transition-all duration-300 text-[#646464] max-md:px-[1.27vw] max-md:left-[3vw] select-none`}
            >
                {labelContent}
