...
export default function Form3({ handlePrevSlide }) {
    ...
    return (
        <>
            <article className='flex relative shadow-input rounded-[1vw] w-full h-fit gap-x-[3.5vw] pt-[5.81vw] pb-[2.06vw] px-[2.5vw] '>
                ...
                <div className='relative flex-1'>
                    ...
                    >
                        <textarea
                            ...
                            name=''
                            id=''
                            className='rounded-[0.625vw] py-[1vw] resize-none outline-none px-[1.5vw] border mt-[1.25vw] border-solid border-[#C5C5C5] w-full placeholder:text-[#646464] placeholder:font-normal placeholder:leading-[1.5] text-den title16-600-150'
                ...
                <div className='relative w-[31.25vw] h-full mt-[5.5vw]'>
                    <div className='flex justify-between mb-[1vw]'>
                        <label
                            htmlFor='file'
                            className='text-[#646464] cursor-pointer'
                        >
                            Hình ảnh *
                        </label>
                    ...
                    <div
                        ...
                        className='w-[31.25vw] cursor-crosshair flex items-center justify-center h-[15.5vw] outline-none rounded-[1vw] border border-dotted border-[#c5c5c5]'
                    >
                        <input
                            multiple
                        ...
                        <div className='flex flex-col items-center'>
                            ...
                            <p className='mt-[0.5vw] mb-[0.25vw] text-[#454545] title14-700-150'>
                                Kéo thả hình ảnh nhà đất hoặc bấm vào đây để tải lên
                            </p>
                            <p className='text-[#C7C7C7] title12-400-150'>
