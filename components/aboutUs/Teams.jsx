...
export default function Teams({ t }) {
    ...
    return (
        <section className='flex justify-end items-center px-120 pt-[6.125vw] pb-[9.5625vw] relative max-md:justify-start max-md:pt-0 max-md:pb-[78.1vw] max-md:px-0'>
            <div className='flex-col w-[41.625vw] max-md:w-full px-mb10'>
                <div>
                    <span
                        data-aos='fade-up'
                        className='sub-title max-md:title-mb10-700-150 max-md:tracking-[0.5px]'
                    >
                        {t.aboutUsTeams.subtitle}
                    </span>
                    <h2
                        data-aos='fade-up'
                        className='title56 text-den mt-[0.125vw] max-md:mt-[1.1vw] max-md:title-mb25-700-130 max-md:tracking-[-1.25px]'
                    >
