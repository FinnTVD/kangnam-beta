...
export default function Mission(){
    ...
    return(
        <section className="relative px-[15.5625vw] pt-[13.375vw] pb-[14.5625vw] mt-[3.1875vw] overflow-hidden">
            <Image ref={bgRef} fill src="/images/mission-bg.png" className="top-0 left-0 opacity-60 z-[-2]"></Image>
            ...
            <div className="relative">
                ...
                <Image width={91} height={80} src="/images/quotes.svg" className="absolute top-[-2.5vw] left-[-2.5vw] w-[5.6875vw]"></Image>
