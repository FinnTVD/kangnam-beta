        ...
        <>
            {!handleDataMegaAll() ? (
                ...
                <>
                                ...
                                <SwiperSlide key={index}>
                                    {indexPopup !== 3 ? (
                                        ...
                                        >
                                            <div className='relative w-full h-[10.1875vw] rounded-[0.5vw] overflow-hidden'>
                                                <Image
                                                    className='z-0 object-cover transition-all duration-200 origin-center group-hover/item:scale-110'
                                            ...
                                            <div className='cursor-pointer w-full h-full bg-white rounded-2xl backdrop-blur-2xl p-[1.5vw] max-md:rounded-[13px] max-md:p-[5.3vw] max-md:py-mb10 shadow-input max-md:shadow-newsDetailMb'>
                                                <div className='w-full h-[10.1875vw] relative rounded-lg overflow-hidden max-md:h-[56vw] max-lg:h-[40vw] max-md:rounded-[8px]'>
                                                    <Image
                                                        ...
                                                        className='absolute top-0 left-0 object-cover w-full h-full overflow-hidden transition duration-300 origin-center group-hover/item:scale-110'
                                                    />
                                                </div>
                    ...
                    {handleDataMegaAll()?.data?.length > 5 && (
                        <>
                            <button
                                onClick={handlePrevSlide}
                                className={`${
                                    indexSlider === 0 ? 'hidden' : 'group/item hover:bg-[#D6A279]'
                                } absolute top-1/2 left-[2rem] -translate-x-1/2 -translate-y-1/2 w-[2.8vw] h-[2.8vw] rounded-full border border-solid border-[#D6A279] flex justify-center items-center bg-white z-20 `}
                            >
                                <svg
                                    xmlns='http://www.w3.org/2000/svg'
                                    fill='none'
                                    ...
                                    strokeWidth='1.5'
                                    stroke='#444'
                                    className='w-6 h-6 group-hover/item:stroke-white'
                                >
                                    <path
                                        strokeLinecap='round'
                                        strokeLinejoin='round'
                            ...
                            <button
                                ...
                                className={`${
                                    indexSlider === 10 ? 'hidden' : 'group/item hover:bg-[#D6A279]'
                                } absolute top-1/2 right-[2rem] translate-x-1/2 -translate-y-1/2 w-[2.8vw] h-[2.8vw] rounded-full border border-solid border-[#D6A279] flex justify-center items-center bg-white z-20 `}
                            >
                                <svg
                                    xmlns='http://www.w3.org/2000/svg'
                                    fill='none'
                            ...
                            <div className='bg-[#80808036] w-[60%] h-[0.4vw] rounded-[7.5vw] absolute bottom-[1vw] left-1/2 -translate-x-1/2'>
                                <div
                                    style={{
                                        width: `${((indexSlider + 5) / 5) * 33.333333}%`,
                                    }}
                                    className={`bg-[#D6A279] h-full rounded-[7.5vw] transition-all duration-1000`}
                                ></div>
                            </div>
                        </>
                    )}
