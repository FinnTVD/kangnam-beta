    ...
    return (
        <>
            <div className='absolute top-[30%] left-[7.5vw] w-fit z-10 px-mb10 max-md:left-0 max-md:w-full max-md:top-1/2 max-md:-translate-y-1/2'>
                ...
                <p className='w-[26.25vw] title20-400-150 line-clamp-3 max-lg:w-full title-mb14-400-150 max-lg:title-tl14'>{data?.des}</p>
            </div>
            <div className='absolute -right-[2.87vw] w-[26.9375vw] z-10 bottom-[1.94vw] bg-gradient-mark-home h-fit max-lg:hidden'>
