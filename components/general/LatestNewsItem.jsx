    ...
    return(
        <Link href={`/danh-sach-tin-tuc/${newsItem.slug}`}>
            <div className='group cursor-pointer w-full h-full bg-center bg-no-repeat bg-cover rounded-2xl shadow backdrop-blur-[39.77px] flex overflow-hidden max-md:rounded-[10px]'>
                ...
                <div className="w-[36.875vw] pt-[2.3125vw] pl-[1.875vw] pb-[2.125vw] pr-[3.3125vw] mt-auto ml-[2vw] mb-[2vw] rounded-2xl border border-white border-opacity-80 backdrop-blur-[11px] max-md:w-[75.4vw] max-md:p-[4.26vw] max-md:ml-[4.2vw] max-md:mb-[4.2vw] max-md:rounded-[8px]" style={{background: "linear-gradient(180deg, rgba(255, 255, 255, 0.90) 34.38%, rgba(255, 255, 255, 0.85) 100%)"}}>
                    <div className="flex">
                        <div className="bg-nau-nhat title12-400-150 py-[0.3125vw] px-[1.125vw] bg-opacity-20 rounded-[100px] text-nau-nhat max-md:text-[2.1vw] max-md:py-[1.1vw] max-md:px-[2.4vw]">{newsItem.category}</div>
                        <div className="ml-[1.125vw] flex items-center max-md:ml-[2.6vw]">
                            <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21" fill="none" className="w-[1.3125vw] h-auto max-md:w-[2.6vw]">
                                <g opacity="0.7">
                            ...
                            <span className="text-[#656263] title14-400-150 ml-[0.375vw] opacity-70 max-md:title-mb10-400-150 max-md:ml-[0.8vw]">{newsItem.date}</span>
                        </div>
                    </div>
                    <div className="mt-[0.625vw] max-md:mt-[0.5vw]">
                        <div className="w-full flex flex-col">
                            <h2 className="text-den-2 title20-700-150 group-hover:text-[#D6A279] transition duration-300 line-clamp-2 max-md:title-mb14-700-150">{newsItem.title}</h2>
                    ...
                    <Button className="mt-[1.375vw] max-md:!gap-x-[1.3vw] max-md:border-opacity-50 max-md:!py-[1.6vw] max-md:!px-[4.2vw]" span="max-md:text-10mb max-md:opacity-70" icon="max-md:w-[3vw]" href={null}>Chi tiết</Button>
                </div>
            </div>
        </Link>
    )
